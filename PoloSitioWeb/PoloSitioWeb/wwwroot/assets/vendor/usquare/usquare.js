(function (jQuery) {
                ...
                if (!this.$item.data('showed')) {
                    ...
                    if (item_position.top > 0) // && this.$parent.width()>=640)
                    {
                        ...
                        if (moving) {
                            ...
                            this.$item.animate({
                                top: top_string
                            }, speed, this.options.easing, function () {
                                ...
                                this_backup.$trigger_text.animate({
                                    'top': 0
                                }, 'slow');
                            });
                        }
                    ...
                    }, 'slow', this.options.easing, function () {
    ...
    function uSquare(element, options) {
        ...
        $.each(this.$items, function (i, element) {
            new uSquareItem(element, $.extend(self.options, {
